...
<head>
<ak:framework />
<title>智能运检系统 | 故障异常-交流-编辑</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<link href="res/faultTrip_dc.css" rel="stylesheet" type="text/css" />
</head>
<body>
<body style="background:#EBEEF7"> 
		<div style="height: 64%;width: 99%;background:white; margin: 0 auto; " >
 		<form id="form"  style="margin-top: 6px; text-align: center;margin: 0 auto;border:  0px black solid;height:100%;width:88%"><!-- style="border:1px black solid" --> 
			 ...
			 <table style="margin-top: 5px;border:  0px black solid;width: 100%; height:90%;border-collapse: separate; border-spacing: 0px 16px;">
				<tr style="border:  0px black solid;">
					...
					<td style="text-align: right;width:13.3%;"><span style="color: red;">   </span>运维单位</td>
					<td> 
				...
				<tr >
					...
					<td >
						<input id="stationFaultOrNot" class="ak-combobox text-box"
				...
				<tr>
					...
					<td><input id="faultPhaseId" class="ak-combobox text-box"
						style="width: 262px;" textField="text" valueField="id"
						emptyText="请选择..." url="" required="true" allowInput="false" 
						name="faultPhaseId" showNullItem="true" nullItemText="请选择..." /></td>
				...
				<tr>
					<td style="text-align: right; " ><span style="color: red;"> * </span>故障原因</td>
					<td><input id="faultReason" style="width:262px"  class="ak-textbox"
					 emptyText="请输入" name="faultReason"
					...
					<td><input id="weather" style="width:262px"  class="ak-textbox"
					 emptyText="请输入" name="weather"
						showNullItem="true"   /></td>
					<td  style="text-align: right;" ><span style="color: red;">   </span>保护动作情况</td><br/>
					<td >
						<input id="protection"  class="ak-textbox" emptyText="保护动作情况" 
				...
				<tr>
					 <td  style="border:  0px black solid;text-align: right; ">
						 <div style="margin-top: -42px;"><span style="color: red;">  </span>是否闭锁</div>
						 <div style="position: absolute;margin-left: 19px;margin-top: 27px;">
						 	<span style="color: red;">   </span>是否三跨区段</div>
					 </td>
					 <td style="border:  0px black solid;">
						 <input id="blockOrNot"   class="ak-combobox text-box"
							style="margin-top: -61px;width: 262px;" textField="text" valueField="id"
							emptyText="请选择..." required="true" allowInput="false"
							 name="blockOrNot" showNullItem="true" nullItemText="请选择..." />
							</br>
						 <input id="threeSpanOrNot"   class="ak-combobox text-box"
							 style="position: absolute;  border-width: 0px; width: 262px; 
							 margin-left: -131px;width: 262px;margin-top: -2.5px;" textField="text" valueField="id"
							 emptyText="请选择..." required="true" allowInput="false" 
							 name="threeSpanOrNot" showNullItem="true" nullItemText="请选择..." />
					 </td>
					 <td  style="border:  0px black solid;text-align: right; ">
						 <div style="margin-top: -42px;"><span style="color: red;">   </span>极闭锁动作情况</div>
						 <div style="position: absolute;margin-left: 112px;margin-top: 27px;">
						 	<span style="color: red;">  </span>是否抢修</div>
					 </td>
					 <td style="border:  0px black solid;">
						 <input id="blockCase"   class="ak-textbox"
							style="margin-top: -61px;width: 262px;" textField="text" valueField="id"
							emptyText="请选择..." required="true"  
							 name="blockCase" showNullItem="true" nullItemText="请选择..." />
							</br>
						 <input id="repairOrNot"   class="ak-combobox text-box"
							style="position: absolute;border-width:0px;width:262px;margin-left: -131px;margin-top:-3px;
							width: 262px;" textField="text" valueField="id" emptyText="请选择..." required="true"
							allowInput="false"name="repairOrNot"showNullItem="true" nullItemText="请选择..." />
					 </td>
					 <td  style="    border:  0px black solid;text-align: right; ">
	 			...
	 			<tr>
					...
					<td><input id="recoveryDate" class="ak-datepicker" 
	 				...
	 				<td style="text-align: right; " >附件</td>
						...
						nullItemText="请选择..." name="attachment" />
	 			...
	 			<tr>
					 ...
					 <td style="border:  0px black solid;"  > <textarea
					 	 class="ak-textarea text-box"
					 		id="faultDetail" emptyText="请输入工作内容" 
					 		style="height: 80px;width:262px" name="faultDetail"></textarea> 
					 </td>
					  <td  style="    border:  0px black solid;text-align: right; ">
					 	 <div style="margin-top: -42px;"> <span style="color: red;">   </span>处理详情</div> 
					 </td>
					 <td style="border:  0px black solid;"  > <textarea class="ak-textarea text-box"
					 		id="managementDetail" emptyText="请输入工作内容" 
					 		style="height: 80px;width:262px" name="managementDetail"></textarea> 
					 </td>
	 				 <td >  
					 </td>
					 <td >
				...
				<div size="80%" showCollapseButton="false">
					<div class="ak-splitter" vertical="false" allowResize="false"
						handlerSize="0" style="width: 100%; height: 100%;">
							...
							<div size="42%" showCollapseButton="false"   >
								<div align="center" style="border-left: 1px solid #cccccc;
								   border-top: 1px solid #cccccc;    border-right: 1px solid #cccccc; 
								   line-height: 32px ;    background: #ebeef5;	width:99.6%;height:17.2%;
								   font-weight: bold;">
									   跟踪内容
								 </div>
								<textarea id="trackContent" class="ak-textarea text-box"  style="width:100%;height: 143px;;" emptyText="请输入工作内容" ></textarea> 
							</div>
					</div>
				</div>
		</div>

...
if __name__=="__main__":
    ...
    # logger.setLevel(29)
    handler  = logging.FileHandler("C:\\Users\\zhaoyun\\PycharmProjects\\basic\\多线程\\test1.log")
    handler.setFormatter(logging.Formatter("%(asctime)s %(message)s %(thread)s %(school)s"))

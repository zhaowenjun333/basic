            ...
            with SBDB.session_scope() as session :
                ...
                if sb_id is None:
                    ...
                    try:
                        ...
                        session.query(SBDB_ORM.Apartment_Relayer).filter(and_(SBDB_ORM.Apartment_Relayer.relayer_id==sb_id,SBDB_ORM.Apartment_Relayer.apartment_id==apartment_id)).delete()

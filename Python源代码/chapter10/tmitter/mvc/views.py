...
def friend_remove(request,_username):
    ...
    try:
        ...
        return __result_message(request,_('Successed'), 'Friend "%s" removed.' % _friend.realname)
    except:
        return __result_message(request,_('Undisposed'), 'He/She dose not your friend,undisposed.')
